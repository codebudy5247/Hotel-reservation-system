export const hotels = [
  {
    name: "Flagship Hotel Olive Saffron",
    location: {
      state: "delhi",
      city: "delhi",
      zip: "234567",
      street: "6,Pocket 15-a, Sector-24, Rohini, Near Rithala Metro Station, Delhi",
      country: "india",
    },
    price: "499",
    images: [
    ...
    policies: [
        "Check-in allowed for guests aged 21 years and above only",
          ...
          "This hotel is serviced under the trade name of Hotel Prince Residency as per quality standards of OYO"
    ],
  },
  {
    name: "Dream Town Near V3S Mall",
    location: {
        state: "delhi",
        city: "delhi",
        zip: "234567",
        street: "28/4, Gali No 16/17, Viswas Nagar, Shahdara, Delhi",
        country: "india",
    },
    price: "579",
    images: [
  ...
  {
    name: "Townhouse 99 Rudra Inn Near Chhatarpur Metro Station",
    location: {
        state: "delhi",
        city: "delhi",
        zip: "234567",
        street: "D-88, 100 Feet Road, Chattarpur Enclave, Chattarpur, Delhi",
        country: "india",
    },
    price: "1065",
    images: [
  ...
  {
    name: "Townhouse OAK Hotel Belsons Taj Mahal",
    location: {
        state: "telangana",
        city: "hyderabad",
        zip: "234567",
        street: "Main Guard Road, Ward 149 Begumpet, Greater Hyderabad Municipal Corporation North Zone, Secunderabad Mandal Hyderabad Telanganaindia, Hyderabad",
        country: "india",
    },
    price: "1150",
    images: [
  ...
  },
  {
    ...
    location: {
        ...
        city: "hyderabad",
        zip: "234567",
        street: "Rudra Colony, Shamshabad, Shamshabad Mandal, Rangareddy, Hyderabad",
        country: "india",
    },
    price: "454",
    images: [
  ...
  {
    name: "Capital O Alpine Glow Sunrise Near Hyderabad Public School",
    location: {
        state: "telangana",
        city: "hyderabad",
        zip: "234567",
        street: "Plot No 1-11-112/a&b, Near Rbi Quarters, Opposite Lane To Amd Quarters, Shyamlal Building, Begumpet, Hyderabad",
        country: "india",
    },
    price: "3279",
    images: [
  ...
  {
    name: "Townhouse 106 Airport Road",
    location: {
        state: "karnataka",
        city: "bangalore",
        zip: "234567",
        street: "15 & 16, 4th Cross, Brindavan Layout, Vidya Nagar Cross, New Airport Road, Near N R V Hospital, Bangalore",
        country: "india",
    },
    price: "2912",
    images: [
  ...
  {
    name: "SPOT ON Janapriya Lodge Near Hare Krishna Hill",
    location: {
        state: "karnataka",
        city: "bangalore",
        zip: "234567",
        street: "#39/2 Shree Mansion, S C Road, Bazaar Street, Yeshwanthpura, Rajarajeshwari Nagar Zone, Bangalore North, Bangalore Urban, Bangalore",
        country: "india",
    },
    price: "2060",
    images: [
  ...
  {
    name: "Super OYO Flagship Aaira Inn Near Uttam Sagar",
    location: {
        state: "karnataka",
        city: "bangalore",
        zip: "234567",
        street: "27, Sankhal Complex, 3rd Cross, Subrna Paliya, Banswadi Main Road, Bangalore",
        country: "india",
    },
    price: "2060",
    images: [
  ...
  {
    name: "Townhouse OAK SRK White Inn Near Ragigudda Sri Prasanna Anjaneyaswamy Temple",
    location: {
        state: "karnataka",
        city: "bangalore",
        zip: "234567",
        street: "71, 3rd Cross Road, Koramangala 2nd Block, Koramangala, Bangalore",
        country: "india",
    },
    price: "4017",
    images: [
